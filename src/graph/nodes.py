...
AGENCY_KEYWORDS = {
    "CBN": [
        ...
        "forex", "foreign exchange", "aml", "anti-money laundering",
        "basel", "capital adequacy", "psp", "payment service",
        "dmb", "deposit money bank",
    ],
    "SEC": [
        "sec", "securities", "capital market", "investment", "stockbroker",
        "shares", "ipo", "bonds", "listed company", "public offer",
        "asset management", "fund manager", "digital asset", "crypto",
        "sharia", "islamic finance", "credit enhancement",
    ],
    "NDPC": [
        "data protection", "privacy", "ndpc", "personal data", "data subject",
        "gdpr", "ndpa", "data controller", "consent", "erasure", "dpo",
        "ndpr", "data breach", "data processor",
    ],
    "NRS": [
        "nrs", "nigeria revenue service", "tax", "income tax", "vat", "levy",
        "withholding", "filing", "assessment", "nigeria tax act",
        "tax return", "tax compliance", "penalty",
    ],
    "FIRS": [
        "firs", "federal inland revenue", "companies income tax", "cita",
        "cit", "company tax", "petroleum profit tax", "education tax",
    ],
    "CAC": [
        "cac", "incorporation", "company registration", "corporate affairs",
        "cama", "memorandum", "articles of association", "directorship",
        "shareholding", "registered company", "business name",
        "limited liability", "public company", "private company",
    ],
    "NCC": [
        "ncc", "telecoms", "telecommunications", "communications act",
        "spectrum", "telecom license", "mobile network", "internet service",
        "data service provider", "virtual network",
    ],
    "NITDA": [
...
def query_analyser(state: RegNaijaState) -> RegNaijaState:
    ...
    if not detected:
        detected = ["CBN", "SEC", "NDPC", "NRS", "CAC", "NCC", "NITDA"]
