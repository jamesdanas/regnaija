...
WATCH_TARGETS = [
    ...
    },
    {
        ...
        "url": "https://ndpc.gov.ng/NDPA2023.html",
...

    {
        "agency": "CBN",
        "name": "CBN Circulars",
        "url": "https://www.cbn.gov.ng/Regulations/listcirculars.asp",
        "base_url": "https://www.cbn.gov.ng",
        "selectors": ["a[href$='.pdf']"],
    },
    {
        "agency": "SEC",
        "name": "SEC Nigeria Rules",
        "url": "https://sec.gov.ng/rules-regulations/",
        "base_url": "https://sec.gov.ng",
        "selectors": ["a[href$='.pdf']", "a[href*='wp-content']"],
    },
    {
...
REGISTRY_PATH = Path("data/watcher_registry.json")
DOWNLOAD_DIR  = Path("data/watcher_downloads")
